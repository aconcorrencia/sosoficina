package com.aconcorrencia.br.sosoficinaapp.sendphp;
...
public class Image {
    ...
    public void getProportionalBitmap(File file,
        ...
        if (w == newDimensionXorY) {
            newDimensionXorY = newDimensionXorY + 1;
        }
        ...
        if (XorY.toLowerCase().equals("x")) {
            ...
            auxBitmap = Bitmap.createScaledBitmap(
